    ...
    BigUniversal arcsin()
    {
        ...
        } else
        {
            ...
            } else
            {
                ...
                BigDecimal binomial = a.pow(2).add(b.pow(2));
                BigDecimal re = Maths.sgn(a).multiply(new BigDecimal("0.5")).multiply(Maths.arccos(root.subtract(binomial)));
                BigDecimal im = Maths.sgn(b).multiply(new BigDecimal("0.5")).multiply(Maths.arcosh(root.add(binomial)));
