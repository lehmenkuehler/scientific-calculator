...
public class History {
    ...
    String getLastResult(Context c) {
        history = c.getSharedPreferences(c.getResources().getString(R.string.SHARED_PREFERENCES_HISTORY), Context.MODE_PRIVATE);
        index = history.getInt("index", 0);
        return history.getString(index + "_result", "0");
    }
